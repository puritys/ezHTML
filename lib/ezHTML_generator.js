...
o.transformImage = function(lines, obj) {/*{{{*/
    var i, n, line, REG, mat, url, attrsData, style, attributes, attr = "", divStyle, html, content, className, REG_End, imgBlock;
    REG = /#img[\s]([^#]+)#?/;
    REG_End = /[\s]*#imgEnd#/;
    line = lines[obj.i];
    mat = line.match(REG);
    ...
    if (attributes.attributes.left === true ) {
        className = "image-left";
    } else if (attributes.attributes.right === true) {
    ...
    if (className) {
        ...
        html = ['<div class="image-wrap">',
                '<div class="'+ className +'">',
                    '<a href="' + url + '" target="_blank"><img src="' +  url + '"  '+ attr + ' ' + style + '/></a>',
                '</div>',
                '<div class="content">'];
        ...
        html = '<div style="text-align:center"><a href="' + url + '" target="_blank"><img src="' +  url + '"  '+ attr + ' ' + style + '/></a></div>';
